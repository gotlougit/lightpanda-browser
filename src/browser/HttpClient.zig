...
//
// (Telemetry was removed; this comment originally referenced it as an example
// of a secondary HTTP user that shares the CA blob but not the connection pool.
// The abortList() isolation remains relevant for any future secondary user.)
